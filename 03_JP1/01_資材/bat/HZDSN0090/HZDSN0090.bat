...
rem
rem 引数:
rem   - なし（自フォルダの HZDSN0090.ini を使用）
rem
rem ログ:
rem   - exec\log\HZDSN0090\HZDSN0090_yyyyMMdd_HHmmss_{out|err}.log
rem     ※出力は共通バッチ側で実施
rem
rem 戻り値:
...
rem
rem 注意:
rem   - 本ファイルの配置: exec\bin\bat\HZDSN0090\HZDSN0090.bat
...
call "%HERE%..\..\common\run_winscp.bat" "%HERE%HZDSN0090.ini" "HZDSN0090"
exit /b %ERRORLEVEL%
